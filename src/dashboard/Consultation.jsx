...
const Consultation = () => {
  ...
  const doctors = [
    { id: 1, name: "Dr. Arpit Gupta", spec: "General Physician", exp: "10 yrs", rating: 4.8, reviews: 156, img: "https://i.pravatar.cc/150?img=1", available: true, hospital: "Kokilaben Dhirubhai Ambani Hospital, Nipania", education: "MBBS, MD (General Medicine)", languages: ["English", "Hindi"] },
    { id: 2, name: "Dr. Sarvesh Maru (MD MEDICINE)", spec: "General Physician", exp: "12 yrs", rating: 4.7, reviews: 203, img: "https://i.pravatar.cc/150?img=2", available: true, hospital: "The Row Eight Complex, near Akash Hospital", education: "MBBS, MD (Medicine)", languages: ["English", "Hindi"] },
    { id: 3, name: "Dr. Gayatri Mishra", spec: "General Physician", exp: "9 yrs", rating: 4.5, reviews: 89, img: "https://i.pravatar.cc/150?img=3", available: true, hospital: "305 Omaxe City, Super Corridor Rd", education: "MBBS, MD", languages: ["English", "Hindi"] },
    { id: 4, name: "Dr. Sumit Sinha - GSS CLINIC", spec: "General Physician", exp: "11 yrs", rating: 4.6, reviews: 134, img: "https://i.pravatar.cc/150?img=4", available: true, hospital: "ACHYUTAM, Scheme 54 Rd, near Apollo Rajshree Hospital", education: "MBBS, MD", languages: ["English", "Hindi"] },
    { id: 5, name: "Dr. Kehari Kumar Agrawal", spec: "General Physician", exp: "15 yrs", rating: 4.9, reviews: 278, img: "https://i.pravatar.cc/150?img=5", available: true, hospital: "Advanced Family Clinic, Garipipliya Rd", education: "MBBS, MD (Medicine)", languages: ["English", "Hindi"] },
    { id: 6, name: "Dr. Archana Rathi", spec: "General Physician", exp: "13 yrs", rating: 4.8, reviews: 192, img: "https://i.pravatar.cc/150?img=20", available: true, hospital: "12 Saket Nagar Main Rd", education: "MBBS, MD (Diabetology)", languages: ["English", "Hindi"] },
    { id: 7, name: "Dr. JAI SINGH", spec: "General Physician", exp: "8 yrs", rating: 4.4, reviews: 76, img: "https://i.pravatar.cc/150?img=7", available: true, hospital: "B-59, behind Laural International School, Airport Rd", education: "MBBS", languages: ["English", "Hindi"] },
    { id: 8, name: "Dr. Sudhanshu J. Agnihotri", spec: "General Physician", exp: "14 yrs", rating: 4.7, reviews: 165, img: "https://i.pravatar.cc/150?img=8", available: true, hospital: "14 New Palasia", education: "MBBS, MD", languages: ["English", "Hindi"] },
    { id: 9, name: "Dr. Azad Singh", spec: "General Physician", exp: "10 yrs", rating: 4.3, reviews: 112, img: "https://i.pravatar.cc/150?img=9", available: true, hospital: "8, opposite Airport, Airport Rd", education: "MBBS", languages: ["English", "Hindi"] },
    { id: 10, name: "Dr. Prabhat Jain", spec: "General Physician", exp: "16 yrs", rating: 4.6, reviews: 148, img: "https://i.pravatar.cc/150?img=10", available: true, hospital: "30, Major District Rd, Sudama Nagar", education: "MBBS, MD", languages: ["English", "Hindi"] },
    { id: 11, name: "Dr. Poonam Bhatia", spec: "Pediatrician", exp: "12 yrs", rating: 4.9, reviews: 231, img: "https://i.pravatar.cc/150?img=11", available: true, hospital: "Tot's 2 Teens Child Guidance Clinic, Civil Lines Rd", education: "MBBS, MD (Pediatrics)", languages: ["English", "Hindi"] },
    { id: 12, name: "Sai Clinic & Child Health Care", spec: "Pediatrician", exp: "9 yrs", rating: 4.5, reviews: 98, img: "https://i.pravatar.cc/150?img=12", available: true, hospital: "Kalyan Sampat Vihar, Sai Clinic 239A", education: "MBBS, DCH", languages: ["English", "Hindi"] },
    { id: 13, name: "Dr. Raunak Sharma", spec: "Orthopedic", exp: "11 yrs", rating: 4.7, reviews: 184, img: "https://i.pravatar.cc/150?img=13", available: true, hospital: "102, Civil Lines Rd, Dewas", education: "MBBS, MS (Orthopedics)", languages: ["English", "Hindi"] },
    { id: 14, name: "Dr. Jagdish Nagar", spec: "Orthopedic", exp: "14 yrs", rating: 4.6, reviews: 156, img: "https://i.pravatar.cc/150?img=14", available: true, hospital: "Opposite Chotichimniya Bai School, MG Rd", education: "MBBS, MS (Orthopedics)", languages: ["English", "Hindi"] },
    { id: 15, name: "Dr. Alisha Pathan", spec: "Gynecologist", exp: "8 yrs", rating: 4.8, reviews: 142, img: "https://i.pravatar.cc/150?img=15", available: true, hospital: "Rajjab Ali Marg, Nayapura, near Bada Bazar", education: "MBBS, MS (OB-GYN)", languages: ["English", "Hindi", "Urdu"] },
    { id: 16, name: "Dr. Gopal Binnani", spec: "General Physician", exp: "18 yrs", rating: 4.9, reviews: 312, img: "https://i.pravatar.cc/150?img=6", available: true, hospital: "MG Rd, Dewas", education: "MBBS, MD (Medicine)", languages: ["English", "Hindi"] },
    { id: 17, name: "Dr. Kuldeep Shrivastava", spec: "General Physician", exp: "13 yrs", rating: 4.5, reviews: 127, img: "https://i.pravatar.cc/150?img=17", available: true, hospital: "Chamunda Complex, AB Rd, near Indian Coffee House", education: "MBBS, MS (ENT)", languages: ["English", "Hindi"] },
    { id: 18, name: "Dr. BRC Clinic@Home", spec: "General Physician", exp: "20 yrs", rating: 4.9, reviews: 445, img: "https://i.pravatar.cc/150?img=18", available: true, hospital: "N-69, Township, near Acropolis College", education: "MBBS, MD", languages: ["English", "Hindi"] },
    { id: 19, name: "Dr. Ashwini Verma (TruHealth Clinic)", spec: "General Physician", exp: "10 yrs", rating: 4.7, reviews: 163, img: "https://i.pravatar.cc/150?img=19", available: true, hospital: "Agrasen Nagar, Vanmandal Rd, near Nandini Dairy", education: "MBBS, MD", languages: ["English", "Hindi"] },
    { id: 20, name: "Shree Ji Multi-Speciality Clinic", spec: "General Physician", exp: "7 yrs", rating: 4.4, reviews: 88, img: "https://i.pravatar.cc/150?img=16", available: true, hospital: "45 Vijay Nagar Main Rd", education: "MBBS", languages: ["English", "Hindi"] },
  ];
