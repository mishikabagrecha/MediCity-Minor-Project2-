...
import { ShieldCheck, Activity, Plus, RefreshCw, Play, Navigation, Info, Phone } from 'lucide-react';
         ...
         <div className="w-full lg:w-[35%] flex flex-col gap-6 shrink-0">
            ...
            <div className="px-2">
               ...
               <p className="text-slate-500 text-sm font-medium leading-relaxed max-w-[280px]">
                  Welcome back! Here's what's happening with your health tracking protocols today.
               </p>
            </div>

            {/* 3D Model Display Stage */}
            <div className="bg-black rounded-[2.5rem] flex-1 relative overflow-hidden min-h-[450px] shadow-xl border border-slate-800">
         ...
         <div className="w-full lg:w-[65%] flex flex-col gap-6">
            ...
            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 flex items-center justify-between relative overflow-hidden">
               <div className="flex-1 z-10 relative">
                  ...
                  <h2 className="text-3xl font-bold text-slate-800 mb-2">Welcome back, {user?.name || 'Aditya'}!</h2>
               ...
               {/* Doctors Vector Image (Mockup replacement using colorful overlapping blobs and icons if external assets fail) */}
               <div className="hidden md:flex absolute right-0 bottom-0 h-full w-1/3 items-end justify-end p-6">
                  {/* Styled fallback to emulate the graphical pop of the image */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 h-full">
               ...
               <div className="bg-white rounded-[2.5rem] p-6 sm:p-8 shadow-sm border border-slate-100 flex flex-col justify-between group">
                  <div>
                     <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="w-12 h-12 rounded-full border-[4px] border-blue-500 border-r-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs shrink-0">
                           78%
                        </div>
                     </div>
                     <h4 className="font-black text-slate-800 text-xl mb-1">78% completed</h4>
                     <p className="text-xs text-slate-500 font-medium tracking-wide">Next due: Tdap - 2025-03-12</p>
                  </div>
                  <div className="mt-8 flex justify-between items-center">
                     ...
                     <p className="text-[10px] text-slate-400 font-bold flex items-center gap-1 uppercase tracking-wider"><RefreshCw size={10} /> Up to date</p>
                  </div>
               </div>
               ...
               <div className="bg-white rounded-[2.5rem] p-6 sm:p-8 shadow-sm border border-slate-100 flex flex-col justify-between group">
                  <div>
                     <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="flex items-center gap-1 text-[10px] uppercase tracking-wider font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full"><ShieldCheck size={12}/> Clear</span>
                     </div>
                     <h4 className="font-bold text-slate-800 text-sm mb-1">Last scan: No issues detected</h4>
                     <p className="text-xs text-slate-500 font-medium tracking-wide">Last scanned: 3 days ago</p>
                  </div>
                  <div className="mt-8 flex justify-between items-center">
               ...
               <div className="bg-white rounded-[2.5rem] p-6 sm:p-8 shadow-sm border border-slate-100 flex flex-col justify-between group">
                  <div>
                     ...
                     <h4 className="font-black text-slate-800 text-xl mb-1">Streak: 7 days</h4>
                     <p className="text-xs text-slate-500 font-medium tracking-wide">Next: Yoga - Tomorrow 7:00 AM</p>
                  </div>
                  <div className="mt-8 flex justify-between items-center">
                     {/* Avatar Pile Mockup */}
               ...
               <div className="bg-white rounded-[2.5rem] p-6 sm:p-8 shadow-sm border border-slate-100 flex flex-col justify-between group">
                  <div>
                     <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="flex items-center gap-1 text-[10px] uppercase tracking-wider font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full border border-emerald-100">Ready</span>
                     </div>
                     <h4 className="font-bold text-slate-800 text-sm mb-1">All systems normal</h4>
                     <p className="text-xs text-slate-500 font-medium tracking-wide">No recent alerts</p>
                  </div>
                  <div className="mt-8 flex flex-col gap-2">
                     ...
                     <div className="flex items-center justify-between gap-4">
                        ...
                        <p className="text-[10px] text-slate-400 font-bold flex items-center uppercase tracking-wider shrink-0 text-right">No recent alerts</p>
                     </div>
                  </div>
               </div>
